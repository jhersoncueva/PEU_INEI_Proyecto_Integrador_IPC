...
csv_path = current_dir / 'base_period' / 'IPC_MIFARMA.csv'

current_date = datetime.now().strftime('%Y-%m-%d')
output_path = current_dir / 'data' / 'raw' / 'mi_farma' / current_date
output_path.mkdir(parents=True, exist_ok=True)

# Algolia / Mi Farma
ALGOLIA_APP_ID = "O74E6QKJ1F"
ALGOLIA_API_KEY = "33d467e73eaf45a846bd178f627e12c3"
...
def main():
    ...
    for idx, row in df.iterrows():
        ...
        if all_rows:
            ...
            filename = f"mifarma_consolidado_{current_date}.xlsx"
