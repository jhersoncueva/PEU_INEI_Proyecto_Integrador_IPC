"""
SCRAPER METRO - Por Categorías y Subcategorías
"""
import os
import time
import random
...
output_path = current_dir / 'data' / 'raw' / 'metro' / current_date
...
# ---------------- CATEGORÍAS (Supermercado Metro Perú) ----------------
...
def get_products_from_category(cat_slug, subcat_slug):
    """
    Extrae los productos desde la API de Metro (VTEX)
    """
    all_products = []
    page = 1
    max_pages = 15
...
def main():
    print("=" * 80)
    print("SCRAPER METRO - Generación de Archivo Consolidado")
    print("=" * 80)
    ...
    if todos_los_productos:
        ...
        archivo_consolidado = output_path / f"CONSOLIDADO_metro_{current_date}.xlsx"
