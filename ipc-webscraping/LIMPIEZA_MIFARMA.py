...
input_base = current_dir / 'data' / 'raw' / 'mi_farma'
output_base = current_dir / 'data' / 'processed' / 'mi_farma'
...
def cargar_archivos_por_fecha(fecha=None):
    """Carga archivos Excel de MiFarma por fecha"""
    todos_los_datos = []
...
def main():
    print("LIMPIEZA DE DATOS - MiFarma")
    if FECHA_ESPECIFICA:
    ...
    output_file = output_path / f'mifarma_limpio_{fecha_str}.xlsx'
